...
/*
 * UART specific definitions below can be defined in a separate include file with name uart_definitions.h instead modifying this file
 * by adding -D_UART_DEFINITIONS_FILE to the CDEFS section in the Makefile
 * All definitions added to the file uart_definitions.h will override the default definitions from uart.h
 */
#ifdef _UART_DEFINITIONS_FILE
